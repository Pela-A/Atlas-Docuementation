...
Screenshots of your application (need to wait a little)
Copy of the PowerPoint presentation (need to complete)
Zipped file of all your source code (Wait until code done)
  ...
  <body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container" style="padding-top: 80px;">
            ...
            <h1 class="text-center">The Atlas Project Documentation</h1>
